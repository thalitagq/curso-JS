(function () {
  ...
  */
  ...
  var fullName = 'thalita-gonçalves-de-queiroz';
  ...
  */
  ...
  var strAmigos = amigos.join(', ');

  var frase = amigos.reduce(function (acumulado, item, index) {
  ...
  */
  ...
  for (let index = 0; index < myName.length; index++) {
    if (index % 2 === 0) {
      newMyName += myName[index].toUpperCase();
      continue;
    }
    newMyName += myName[index]
  }
