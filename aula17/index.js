(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Thalita Gonçalves'));
  ...
  */
  ...
  var mes = 'março';
  console.log('O mês de ' + mes + ' é reprensentado pelo número ' + getMonthNumber(mes));
  ...
  */
  ...
  function replaceDate(texto) {
    return texto.replace(regexDate, function () {
      return arguments[1] + '/' + getMonthNumber(arguments[3]) + '/' + arguments[5];
    });
  }
