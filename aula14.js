(function(){
  ...
  */
  ...
  var hasNumber2 = numberObjects.map(function (item) {
    return item.number
  }).indexOf(2);
  hasNumber2 ? console.log('Existe um objeto {number: 2} em numberObjects!') : console.log('Não existe um objeto {number: 2} em numberObjects :(');
  ...
  */
  ...
  hasNumber2 = numberObjects.map(function (item) {
    return item.number
  }).lastIndexOf(2);
  hasNumber2 ? console.log('Existe um objeto {number: 2} em numberObjects!') : console.log('Não existe um objeto {number: 2} em numberObjects :(');
