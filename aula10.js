(function (){
  ...
  */
function isOperandValid(operator) {
  ...
  */
  ...
  invalidOperator
  ?
  console.log(showOperationMessage(operationSignal, number1, number2), invalidOperator(number1, number2)):
  console.log(showErrorMessage(operationSignal));
