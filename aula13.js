(function() {
  ...
  */
  var nordeste = ['Ceará', 'Sergipe', 'Pernambuco', 'Piauí', 'Alagoas', 'Rio Grande do Norte', 'Bahia', 'Maranhão', 'Paraíba'];
  ...
  */
  ...
  seteLetras ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
  ...
  */
  ...
  isCeara ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(');;
